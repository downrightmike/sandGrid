...
public class SandLab{
  ...
  static final String FILE_NAME     = "SandLabFile_new.txt";  //This is the name of the input file.
  static final String NEW_FILE_NAME = "SandLabFile_new.txt";  //This is the name of the file you are saving.
  ...
  public SandLab(int numRows, int numCols){
    //SandLabFiles.setRowsAndCols(numRows, numCols);
  ...
  public static void getRandom(int[][] theArray, int min, int max){
    ...
    for (int r = 0; r < theArray.length; r++){
      for(int c = 0; c < theArray[1].length; c++){
        theArray[r][c]  = (int)(Math.random() * range) + min;
