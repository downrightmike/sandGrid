...
public class SandLab{
  ...
  // This module will modify the water element.
  public void modifyWater(int r, int c) {
    ...
    // If the element selected is water and the element under it is EMPTY (blank), then it'll add water to the
    // row below the selected location for the water. This is done with a loop somewhere else of course for it to act fluidy.
